...
while(cam.isOpened()):
    ...
    if count_defects == 1:
       ...
       if(pinchFlag==0):
            pinchFlag=1
            cv2.putText(img,"Mouse is Released ", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
        ...
        if(pinchFlag==1):
            ...
            cv2.putText(img,"Mouse is Pressed ", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
            draw = True
        ...
        cv2.putText(img,"Three Fingures Detected !!", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    elif count_defects == 4:
        cv2.putText(img,"Four Fingures Detected!!!", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    else:
        cv2.putText(img,"Welcome to Air Paint !!!", (50, 50),cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
